...
it('should render image row', () => {
  const textValues = {subHeadText: 'If possible', altOne: 'image of person dropping to the floor', altTwo: 'image of person moving under cover', altThree: 'image of person holding on to cover'}
  rtl.render(<ImageRow subHeadText={textValues.subHeadText} ImageOne={Drop} altOne={textValues.altOne} ImageTwo={Cover} altTwo={textValues.altTwo} ImageThree={HoldOn} altThree={textValues.altThree} />);
