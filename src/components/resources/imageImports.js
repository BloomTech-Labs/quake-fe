...
export { Drop, Cover, HoldOn, CaneDrop, CaneCover, CaneHoldOn, WalkerLock, WalkerCover, WalkerHoldOn, WheelchairBrake, WheelchairCover, WheelchairHoldOn, BulletPlus, BulletSolid, TriangleUp, STEPLogo, FEMALogo, RedCrossLogo, SalvationArmyLogo, EarthquakeShelterLogo };