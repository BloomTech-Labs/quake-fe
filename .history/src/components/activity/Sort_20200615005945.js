      ...
      <div className={!sortClicked ? "sort-input-closed" : "sort-input-open"}>
        <form role="form" className="sort-input">
          ...
          <select
            ...
            role="list"
          >
            <option role="listitem" tabIndex="0" value="newest">
              Time: Newest First
            </option>
            <option role="listitem" tabIndex="0" value="oldest">
              Time: Oldest First
            </option>
            <option role="listitem" tabIndex="0" value="ascending magnitude">
              Magnitude: Lowest First
            </option>
            <option role="listitem" tabIndex="0" value="descending magnitude">
